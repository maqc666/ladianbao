...
public class NativeTabButton extends FrameLayout {
    ...
    private int mUnselectedColorRes = R.color.color_99;
    ...
    public void setSelectedColor(Boolean selected) {
        if (selected) {
            mTitle.setTextColor(getResources().getColor(R.color.color_first));
        } else {
            mTitle.setTextColor(getResources().getColor(R.color.color_99));
        }
    }
